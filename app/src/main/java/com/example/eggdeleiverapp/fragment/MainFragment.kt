    ...
    private val callback = object : LocationCallback() {
        override fun onLocationResult(result: LocationResult) {
            ...
            if (address == null && !hasMyLoc) {
                ...
                val adres = geocoder.getFromLocation(
                    myLoc.latitude,
                    myLoc.longitude,
                    1
                )
                addresses.clear()
                addresses.addAll(adres)
...
//                    isNetworkConnected()
    ...
    private fun ini(view: View) {
        ...
        progressDialog =
            AlertDialog.Builder(requireContext()).setView(R.layout.dialog_view).setCancelable(false)
                .create()
                ...
                databaseReference.child(ORDER)
                    ...
                    .addOnCompleteListener {
                        if (it.isSuccessful) {
                            ...
                            view.net_connect.visibility = View.GONE
