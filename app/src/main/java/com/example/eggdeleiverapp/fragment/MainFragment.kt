                ...
                .addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        if (snapshot.exists()) {
                            ...
                            if (snapshot.hasChild(addressName)) {

                            }
//                                val myData = HistoryItem(
//                                    snapshot.child(Constant.addressName).value.toString(),
//                                    snapshot.child(Constant.name).value.toString(),
//                                    date = sana!!,
//                                    null,
//                                    snapshot.child(Constant.phone).value.toString(),
//                                    snapshot.child(Constant.count).getValue(Int::class.java)!!
//                                        .toInt(),
//                                    delivered = "xa",
//                                    seen = "xa"
//                                )
...
//                                        Toast.makeText(
//                                            requireContext(),
//                                            "Nimadur xato qaytadan urinib ko'ring",
//                                            Toast.LENGTH_LONG
//                                        ).show()
//                                    }
                        }
        ...
        view.canceling.setOnClickListener {
            removeFromOrderValue()
        }
    }
    ...
    private fun checkView() {
        databaseReference.child(ORDER)
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists()) {
                        inout_order.visibility = View.GONE
